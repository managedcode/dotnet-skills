...
dotnet skills install bundle dotnet-quality # install a focused .NET quality bundle
...
| [`dotnet-chrome-devtools-mcp`](catalog/Tools/Chrome-DevTools-MCP/skills/dotnet-chrome-devtools-mcp/) | `1.0.0` | Use Chrome DevTools MCP from .NET agents and .NET-focused repos to inspect, debug, and automate Chrome through an MCP client. |
...
| Skill | Version | Description |
|-------|---------|-------------|
| [`dotnet-aspire`](catalog/Frameworks/Aspire/skills/dotnet-aspire/) | `1.3.3` | Build, upgrade, and operate .NET Aspire 13.2.x application hosts with current CLI, AppHost, ServiceDefaults, integrations, dashboard, testing, and Azure deployment patterns for distributed apps. |
...
| [`dotnet-microsoft-extensions-ai`](catalog/Libraries/Microsoft-Extensions-AI/skills/dotnet-microsoft-extensions-ai/) | `1.4.0` | Build provider-agnostic .NET AI integrations with `Microsoft.Extensions.AI`, `IChatClient`, embeddings, middleware, structured output, vector search, and evaluation. |
