...
| [`pvanalyze`](catalog/Tools/pvanalyze/skills/pvanalyze/) | `1.0.0` | Use `pvanalyze` to inspect existing .NET `.nettrace` files from the command line, including GC, JIT, CPU stacks, allocation, DATAS, events, exceptions, timeline, and call-tree analysis with JSON or SpeedScope output for automation. |
