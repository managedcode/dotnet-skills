...
- In the interactive shell, installed-skill management must be a first-class lifecycle surface. Expose bulk removal clearly, including `clear target` and a review flow where currently installed skills start checked and unchecking them prepares removal.
