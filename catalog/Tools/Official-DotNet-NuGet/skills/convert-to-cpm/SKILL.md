...
compatibility: "Requires a .NET repository using NuGet package management."
---

<!-- Imported from upstreams/dotnet-skills/dotnet-nuget/skills/convert-to-cpm/SKILL.md via vendir. Edit upstream or catalog-sources config, then rerun scripts/import_external_catalog_sources.py. -->
