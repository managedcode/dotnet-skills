...
<!-- Imported from upstreams/dotnet-skills/dotnet-template-engine/skills/template-validation/SKILL.md via vendir. Edit upstream or catalog-sources config, then rerun scripts/import_external_catalog_sources.py. -->
# Template Validation
