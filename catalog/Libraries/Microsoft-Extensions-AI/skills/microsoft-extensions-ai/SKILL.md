...
- `dotnet/extensions` `v10.8.2` changes only `Microsoft.Extensions.VectorData.ConformanceTests` and its xUnit v3 migration. Runtime MEAI, VectorData, DataIngestion, and evaluation guidance remains on the `v10.8.1` behavior below.
