...
<!-- Imported from upstreams/dotnet-skills/dotnet-test/agents/code-testing-implementer.agent.md via vendir. Edit upstream or catalog-sources config, then rerun scripts/import_external_catalog_sources.py. -->
