...
<!-- Imported from upstreams/dotnet-skills/dotnet-maui/skills/maui-safe-area/SKILL.md via vendir. Edit upstream or catalog-sources config, then rerun scripts/import_external_catalog_sources.py. -->
