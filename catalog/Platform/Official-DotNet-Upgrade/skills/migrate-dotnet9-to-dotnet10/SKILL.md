...
<!-- Imported from upstreams/dotnet-skills/dotnet-upgrade/skills/migrate-dotnet9-to-dotnet10/SKILL.md via vendir. Edit upstream or catalog-sources config, then rerun scripts/import_external_catalog_sources.py. -->
