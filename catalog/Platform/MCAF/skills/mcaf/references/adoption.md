...
- install implementation-focused skills from `https://skills.managed-code.com/`
...
- local `mcaf*` governance skills under the native agent skill directory
- implementation-focused skills from this catalog when the repo contains `.NET` code
...
- "set up repo rules, AGENTS, docs, and delivery workflow" -> start with `mcaf`
- "implement or fix actual ASP.NET/Orleans/EF/Agent Framework code" -> route from `mcaf` into the narrowest implementation-focused skill
- "tighten verification and CI rules" -> combine `mcaf` with the appropriate testing or quality skill
