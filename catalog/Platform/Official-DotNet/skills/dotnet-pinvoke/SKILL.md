...
<!-- Imported from upstreams/dotnet-skills/dotnet/skills/dotnet-pinvoke/SKILL.md via vendir. Edit upstream or catalog-sources config, then rerun scripts/import_external_catalog_sources.py. -->
# .NET P/Invoke
